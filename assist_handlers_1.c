...
/**
 * assist_all - Displays all possible builtin shellby commands
 */
...
/**
 * assist_alias - Displays information on the shell by builtin command 'alias'
 */
void assist_alias(void)
{
	...
	write(STDOUT_FILENO, msg, _strlen(msg));
	msg = " an alias for each NAME whsoe VALUE is given. If NAME ";
	write(STDOUT_FILENO, msg, _strlen(msg));
...
/**
 * assist_cd - Displays information on the shell by builtin command 'cd'
 */
void assist_cd(void)
{
...
/**
 * assist_help - Displays information on the shell by builtin command 'help'
 */
